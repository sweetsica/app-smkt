    ...
    return $(this).each(function () {
        var buildDefaultOptions = function () {
            ...
            setActiveText = function () {
                ...
                const apiUrl = $('#edit_sample_datable').data('update-url').replace('http://', 'https://');
                console.log(apiUrl);

                let editorInput = $(`#edit_sample_datable_input`);
                const data = {
                    id : selectedId
                }
...
const options = {
    cloneProperties: ['padding', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right',
        'text-align', 'font', 'font-size', 'font-family', 'font-weight',
        'border', 'border-top', 'border-bottom', 'border-left', 'border-right'],
    editor: $('<input id="edit_sample_datable_input">'),
    idInput: 'edit_sample_datable_input'
}
// init data base according mindmup-editable.js
$('#edit_sample_datable').editableTableWidget(options);
